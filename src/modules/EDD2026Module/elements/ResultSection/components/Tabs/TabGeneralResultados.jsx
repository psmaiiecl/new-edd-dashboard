...
export function TabGeneralResultados() {
  ...
  return (
    <TabContent>
      <RatiosPanel ratiosNacionales={ratiosNacionales} />
      ...
      <CustomDotLineChart
        title={
          "EVOLUCIÓN DIARIA DE ACCESOS Y DESCARGAS DE <b>INFORMES POR ESTABLECIMIENTO</b>"
        }
        data={AvanceDiarioDescargaDirector}
      />
      <CustomDotLineChart
        title={
          "EVOLUCIÓN DIARIA DE ACCESOS Y DESCARGAS DE<b> INFORMES POR SOSTENEDOR</b>"
        }
