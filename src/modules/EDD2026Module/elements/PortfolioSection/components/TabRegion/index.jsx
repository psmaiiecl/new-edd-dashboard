...
export function TabRegion() {
  const { data } = useTabRegion();
  return (
    <TabContent>
      <div className="general-pie-chart-container">
        <CustomColumnChart
          data={data?.estado_portafolio}
          title={"ESTADO DE AVANCE DEL PORTAFOLIO <b>POR REGIÓN</b>"}
        />
        <hr />
      ...
      <div className="general-pie-chart-container">
        <CustomColumnChart
          data={data?.estado_m1}
          title={"ESTADO DE AVANCE DEL MÓDULO 1 <b>POR REGIÓN</b>"}
        />
        <hr />
      ...
      <div className="general-pie-chart-container">
        <CustomColumnChart
          data={data?.estado_m2}
          title={"ESTADO DE AVANCE DEL MÓDULO 2 <b>POR REGIÓN</b>"}
        />
        <hr />
      ...
      <div className="general-pie-chart-container">
        <CustomColumnChart
          data={data?.estado_m3}
          title={"ESTADO DE AVANCE DEL MÓDULO 3 <b>POR REGIÓN</b>"}
        />
        <hr />
