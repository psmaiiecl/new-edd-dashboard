...
export function PortfolioSection2026() {
    ...
    <ModulePageLayout>
      ...
      >
        <Button
          ...
          action={() => {
            customDownload({
              route: BASE_API_URL_2026 + "/portafolio/docente/excel",
              options: { method: "GET" },
        ...
        <Button
          ...
          action={() => {
            customDownload({
              route: BASE_API_URL_2026 + "/portafolio/sostenedor/excel",
              options: { method: "GET" },
        ...
        <Button
          ...
          action={() => {
            customDownload({
              route: BASE_API_URL_2026 + "/portafolio/director/excel",
              options: { method: "GET" },
