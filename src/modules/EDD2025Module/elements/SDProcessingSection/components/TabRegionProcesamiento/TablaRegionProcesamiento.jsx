...
export default function TablaRegionProcesamiento({ data }) {
        ...
        <tbody>
          {data.categories.map((cat, i) => {
            ...
            return (
              <tr key={cat}>
                <td>{cat}</td>
                <td>{data.series[0].data[i]}</td>
                <td>{data.series[8].data[i]}</td>
                <td>{data.series[1].data[i]}</td>
                <td>{data.series[2].data[i]}</td>
                <td>
                  <span
                    style={{
                ...
                <td>{data.series[3].data[i]}</td>
                <td>{data.series[4].data[i]}</td>
                <td>{data.series[5].data[i]}</td>
                <td>{data.series[6].data[i]}</td>
                <td>{data.series[7].data[i]}</td>
                <td>
                  <span
                    style={{
