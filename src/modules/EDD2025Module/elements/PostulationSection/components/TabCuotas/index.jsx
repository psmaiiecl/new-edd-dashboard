        ...
        <table className="roboto-regular">
          <thead>
            ...
            <tr>
              ...
              <th style={{ backgroundColor: "var(--blue-10)" }}>Correctores</th>
              <th style={{ backgroundColor: "var(--blue-10)" }}>
                Seleccionados
              </th>
              <th style={{ backgroundColor: "var(--blue-10)" }}>
              ...
              <th style={{ backgroundColor: "var(--blue-10)" }}>Requeridos</th>
              <th style={{ backgroundColor: "var(--blue-10)" }}>
                Seleccionados
              </th>
              <th style={{ backgroundColor: "var(--blue-10)" }}>
        ...
        <table className="roboto-regular">
          <thead>
            <tr>
              ...
              <th rowSpan={2} style={{ backgroundColor: "#5197d1ff" }}>Seleccionables</th>
              ...
              <th rowSpan={2} style={{ backgroundColor: "#f5f831ff" }}>Lista de Espera</th>
