...
export function TabDependencia() {
  const { chartData, tableData } = useTabDependencia();
  return (
    <TabContent>
      <div className="dual-bar-chart-container">
        <CustomBarChart
          ...
          height={500}
          subtitle={"Agendamiento de Docentes <b>por Dependencia</b>"}
        />
        <CustomBarChart
          table={false}
          data={chartData.establecimientos}
          height={500}
          subtitle={"Agendamiento de Establecimientos <b>por Dependencia</b>"}
        />
      </div>
