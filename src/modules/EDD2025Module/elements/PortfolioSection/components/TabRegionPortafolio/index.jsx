  ...
  return (
    <div className="tab-general-upper">
      ...
      <div className="general-pie-chart-container">
          <GenericColumnChart
            subtitle={"ESTADO DE AVANCE DEL PORTAFOLIO POR REGIÓN"}
            serviceUrl={`${baseURL}/2025-portafolio-avance-region-m1`}
            keyPath=""
            dataMapper={avanceRegionMapper}
          />
        </div>
      <div className="general-pie-chart-container">
          <GenericColumnChart
            subtitle={"ESTADO DE AVANCE DEL PORTAFOLIO POR REGIÓN"}
            serviceUrl={`${baseURL}/2025-portafolio-avance-region-m2`}
            keyPath=""
            dataMapper={avanceRegionMapper}
          />
      </div>
      <div className="general-pie-chart-container">
          <GenericColumnChart
            subtitle={"ESTADO DE AVANCE DEL PORTAFOLIO POR REGIÓN"}
            serviceUrl={`${baseURL}/2025-portafolio-avance-region-m3`}
            keyPath=""
            dataMapper={avanceRegionMapper}
          />
      </div>
