  ...
  const avanceConvocatoriaMapper = (data) =>
    data
      ? {
          ...
          series: [
            { name: "Convocatoria A", y: data.convocatoria_a, color: "#65d9ab" },
            { name: "Convocatoria B", y: data.convocatoria_b, color: "#ff8e53" },
            { name: "Convocatoria C", y: data.convocatoria_c, color: "#ffd153" },
          ]
        }
      : {
          total: {
